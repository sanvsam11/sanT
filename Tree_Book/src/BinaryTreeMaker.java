...
public class BinaryTreeMaker {
    ...
    public void InsertNode(char element) {
        while (true) {
            if (Root == null) {
                ...
                c = Root = newnode;
                BTQueue.push(newnode);
                break;
            } else {
                if (c.left == null) {
                    tnode newnode = new tnode(element);
                    c.left = newnode;
                    BTEnabler.push(newnode);
                    break;
    ...
    public void TreeBoundaryPrinter() {
        c = Root;
        StackMaker RevRit = new StackMaker();
        while (true) {
        ...
        while (true) {
            ...
            if (c == null) break;
                ...
                if (c.left == null && c.right == null) System.out.println(c.element);
                BTQueue.push(c.left);
                BTQueue.push(c.right);
            }
        }
    ...
    public tnode CreateTree_Pre_In(CQueueMaker PQ, CQueueMaker IQ) {
        ...
        if (!(PQ.IsEmpty() || l.IsEmpty() || r.IsEmpty())) {
            N.left = CreateTree_Pre_In(PQ, l);
            N.right = CreateTree_Pre_In(PQ, r);
        }
        return N;
    }
